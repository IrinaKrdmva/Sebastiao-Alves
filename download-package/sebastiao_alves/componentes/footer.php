<footer class="container-fluid my-5 pt-5 pb-3">
    <div class="row d-none d-lg-block">
      <nav class="col-11 py-3 mx-auto d-flex gap-5 justify-content-center">
        ...
        <a onclick="abrirMenu()" class="menus-rodape <?= ($pagina_actual == "livros") ? "active" : ""; ?>">Livros</a>
      ...
      <div class="col-12 col-lg-4 mt-5 mt-lg-0">
        <div class="row text-center mt-5 mt-lg-0">
          ...
          <div class="col-12 mt-4 d-flex justify-content-center gap-4">
            <a href="<?=getContactos("instagram"); ?>" class="icone icone-instagram" target="_blank"></a>
            <a href="<?=getContactos("facebook"); ?>" class="icone icone-facebook" target="_blank"></a>
            <a href="<?=getContactos("linkedin"); ?>" class="icone icone-linkedin" target="_blank"></a>
          </div>
        </div>
      </div>
